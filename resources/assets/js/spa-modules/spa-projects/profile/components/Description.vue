<template>
	<div>
		<el-dialog :visible.sync="descriptionActive" :before-close="close" class="profile-desc-dialog">
				...
				<div class="creative-footer">
					<div>
						<el-button
							...
							type="primary"
							:loading="loading"
							@click="saveDescription('ruleForm')"
						>Save</el-button>
			...
			saveDescription(formName) {
				this.$refs[formName].validate(valid => {
					if (valid) {
						this.loading = true;
						this.$store
							.dispatch("updateProfileDescription", this.ruleForm)
							.then(() => {
								this.loading = false;
								this.close();
							});
