<template>
    <div id="not-found" class="not-found-page">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="520" height="560" viewBox="0 0 520 560">
                <g fill="none" fill-rule="evenodd" transform="translate(3 73)">
                    <g stroke-width="2" transform="rotate(-30 140.579 22.242)">
                        ...
                        <path fill="#FFF" stroke="#4A90E2" d="M102.62 60c8.2 0 14.87-13.43 14.87-30s-6.66-30-14.87-30">
                        </path>
                        <path stroke="#4A90E2" d="M33.46 60c8.22 0 14.87-13.43 14.87-30S41.68 0 33.46 0"></path>
                        <ellipse cx="26.03" cy="30" fill="#FFF" stroke="#0D2B3E" rx="14.87" ry="30"></ellipse>
                        <path fill="#FFF" stroke="#0D2B3E"
                        ...
                        <ellipse cx="11.15" cy="30" fill="#FFF" stroke="#0D2B3E" rx="10.15" ry="21.5"></ellipse>
                        <ellipse cx="79.56" cy="30" stroke="#4A90E2" rx="17.85" ry="18"></ellipse>
                        <ellipse cx="79.56" cy="30" fill="#FFF" stroke="#0D2B3E" rx="13.38" ry="13.5"></ellipse>
                    </g>
                    <path fill="#DDE4EB"
                    ...
                    <g transform="translate(424 130)">
                        <circle cx="45" cy="45" r="45" stroke="#4A90E2" stroke-width="2"></circle>
                        <circle cx="45.83" cy="45.83" r="39.17" fill="#FFF"></circle>
                        <circle cx="47.5" cy="15.83" r="4.17" stroke="#4A90E2" stroke-width="2"></circle>
                        <path stroke="#4A90E2" stroke-linecap="round" stroke-width="2"
                            d="M48.33 25c4.6 0 8.34-3.73 8.34-8.33"></path>
                        <circle cx="70" cy="40" r="6.67" stroke="#4A90E2" stroke-width="2"></circle>
                        <circle cx="19.17" cy="42.5" r="2.5" stroke="#4A90E2" stroke-width="2"></circle>
                        <path stroke="#4A90E2" stroke-linecap="round" stroke-width="2"
                            d="M26.67 42.5a7.5 7.5 0 0 0-7.5-7.5m-7.5 7.5a7.5 7.5 0 0 0 7.5 7.5"></path>
                        <circle cx="53.33" cy="66.67" r="3.33" stroke="#4A90E2" stroke-width="2"></circle>
                        <path stroke="#4A90E2" stroke-linecap="round" stroke-width="2"
                            d="M45 66.67c0 4.6 3.73 8.33 8.33 8.33"></path>
                        <circle cx="19.17" cy="65.83" r="2.5" fill="#4A90E2"></circle>
                        <circle cx="32.5" cy="10.83" r="2.5" fill="#4A90E2"></circle>
                    </g>
                    <path fill="#DDE4EB"
                    ...
                    <g stroke-width="2" transform="rotate(-30 693.38531629 74.76561894)">
                        <rect width="72.05" height="22.36" x="25.68" y="7.09" fill="#FFF" stroke="#0D2B3E" rx="11.18">
                        </rect>
                        <rect width="72.05" height="34.54" x="1" y="1" fill="#FFF" stroke="#0D2B3E" rx="17.27"></rect>
                        <ellipse cx="18.51" cy="18.27" stroke="#4A90E2" rx="17.51" ry="17.27"
                    ...
                    <path stroke="#0D2B3E" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M107.4 354.78l20.25 15.12-20.25-15.12zM75.76 332.1l10.12 7.56-10.12-7.56z"></path>
                    ...
                    <path stroke="#8DDCFF" stroke-linecap="round" stroke-width="2"
                        d="M169.42 329.58a30.3 30.3 0 0 0-30.38-30.24m21.52 31.5a21.47 21.47 0 0 0-21.52-21.42"></path>
                    ...
                    <path stroke="#7ED7FF" stroke-width="2" d="M361.7030833 130.52842676l-17.8049339-7.7449551"></path>
                    <path fill="#FFF" fill-rule="nonzero" stroke="#0D2B3E" stroke-width="2"
                    ...
                    <path stroke="#7ED7FF" stroke-width="2" d="M280.23508038 323.43753826l-27.22702477-17.43517197">
                    </path>
                    <path fill="#FFF" fill-rule="nonzero" stroke="#0D2B3E" stroke-width="2"
                    ...
                    <path stroke="#7ED7FF" stroke-width="2" d="M189.24009043 249.42029566l-19.63254367 3.8161799">
                    </path>
                    <path stroke="#0D2B3E" stroke-width="2"
                        d="M275.89003883 328.33662123l-25.60278694-16.41637296m107.79044764-58.64485824l-21.48773566 20.47625982">
                    </path>
                    <path stroke="#7ED7FF" stroke-width="2" d="M352.8061952 248.16739216l-21.48773565 20.47625982">
                    </path>
                    <path stroke="#4A90E2" stroke-width="2"
                    ...
                    <circle cx="401" cy="44" r="6" fill="#9AC2F0"></circle>
                    <path stroke="#031836" stroke-linecap="round" stroke-width="2" d="M398 53a6 6 0 1 0-6-6"></path>
                    <circle cx="90" cy="164" r="6" fill="#9AC2F0"></circle>
                    <path stroke="#031836" stroke-linecap="round" stroke-width="2" d="M87 173a6 6 0 1 0-6-6"></path>
                    <path fill="#031836"
                    ...
                    <circle cx="377" cy="173" r="4" fill="#031836"></circle>
                    <circle cx="255" cy="403" r="4" fill="#031836"></circle>
                </g>
            </svg>
        </div>
        <div>
            ...
            <p class="text-error-message mb-8 leading-normal">We're lost in space. The page you were trying to view does
                not exist.</p>
            <el-button class="tracking-wide uppercase btn-lg" @click="goToHome">Go Home</el-button>
        </div>
    </div>
</template>
